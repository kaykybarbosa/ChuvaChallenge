...
class _ActivityState extends State<Activity> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      _listParents =
          getIt<EventController>().getEventParentById(widget.event.id);

      _listDependency =
          getIt<EventController>().getEventDependencyById(widget.event.parent);
    });
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          style: _myStyle(_isProcessing),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [_currentBotton],
                          )),
                    ),
                    _listParents.isNotEmpty ? _showParents() : const Text(''),
                    Container(
